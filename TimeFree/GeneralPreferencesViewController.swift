...
//        preferences.moveMousePointer = (sender.state == NSOnState)
//        setupInterface()
//    }
//    
...
//        randomlyMovingMouseButton.state = (preferences.moveMousePointer == true) ? NSOnState : NSOffState
////        movingMouseDelayTextField.enabled = moveMousePointer
